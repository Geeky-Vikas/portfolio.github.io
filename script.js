...
const paragraph = new Typed('.multipara', {
    ...
    strings : ['In the depths of numbers, they find the truth,Predicting trends and forecasting the youth.They tango with models, dancing in their stride,Extracting knowledge, with each dataset tried.'],
    typedSpeed: 100
    // backSpeed: 100,
    // backDelay: 1000,
    // loop: true
